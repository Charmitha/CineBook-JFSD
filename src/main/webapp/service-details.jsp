...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/homepage_5.jpg');">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <a href="bookticket.jsp" class="readmore stretched-link">Let's Start <i class="bi bi-arrow-right"></i></a>
            <div class="col-lg-8" class="center">
            <img src="assets/img/moviebookticket.jpg"  calt="" class="img-fluid services-img">
            <h3 >Thank Your For Exploring, Have Some Fun With Our Services.</h3>
